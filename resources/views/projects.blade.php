        ...
        <div class="content">
            ...
            <div class="container-xxl">
                ...
                <div class="container py-5">
                    <div class="row">
                        <!-- Generate 12 example project cards -->
                        <script>
                            document.addEventListener("DOMContentLoaded", function() {
                                const projectsContainer = document.querySelector('.row');
                                const projects = [
                                    { name: "Community Outreach", wing: "Youth Wing", status: "Active", funded: 75, required: 100 },
                                    { name: "Election Campaign", wing: "Main Wing", status: "Completed", funded: 120, required: 100 },
                                    { name: "Environmental Awareness", wing: "Women's Wing", status: "Active", funded: 50, required: 100 },
                                    { name: "Educational Reform", wing: "Youth Wing", status: "Pending", funded: 20, required: 100 },
                                    { name: "Health Initiative", wing: "Main Wing", status: "Active", funded: 80, required: 100 },
                                    { name: "Social Justice", wing: "Women's Wing", status: "Planning", funded: 30, required: 100 },
                                    { name: "Urban Development", wing: "Main Wing", status: "Active", funded: 60, required: 100 },
                                    { name: "Rural Education", wing: "Youth Wing", status: "Pending", funded: 25, required: 100 },
                                    { name: "Water Sanitation Project", wing: "Women's Wing", status: "Active", funded: 40, required: 100 },
                                    { name: "Cultural Revival Initiative", wing: "Youth Wing", status: "Planning", funded: 10, required: 100 },
                                    { name: "Tech for Good", wing: "Main Wing", status: "Active", funded: 90, required: 100 },
                                    { name: "Food Security Project", wing: "Women's Wing", status: "Active", funded: 85, required: 100 }
                                ];
